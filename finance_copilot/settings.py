"""
Django settings for finance_copilot project.
...
SECRET_KEY = "!_rgz_rov(3c_9d1ttek5y5zp)2n*xsdkf2@1to6xba0d_elb8"
...
WSGI_APPLICATION = "finance_copilot.wsgi.application"
